...
public class SmtpEmailSender : IEmailSender
{
    ...
    {
        var link =
        $"{_settings.ClientBaseUrl}/api/auth/confirm-email?userId={userId}&token={Uri.EscapeDataString(confirmationToken)}"; var subject = "Confirm your StudentInsights account";
